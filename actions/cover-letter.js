...
// server js to handle cover letter generation
...
export async function generateCoverLetter(data) {
  ...
  // save the generated cover letter to the cover letter table
  try {
...
// Function to get all cover letters for the authenticated user
